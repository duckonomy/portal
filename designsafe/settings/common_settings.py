...
MONGO_CLIENT_USER = os.environ.get('MONGO_CLIENT_USER')
MONGO_CLIENT_PASS = os.environ.get('MONGO_CLIENT_PASS')
MONGO_CLIENT_AUTH = os.environ.get('MONGO_CLIENT_AUTH')
MONGO_CLIENT_PORT = os.environ.get('MONGO_CLIENT_PORT')
