...
# look at the agave tenant baseurl in the DS.env file
RESTHEART_CLIENT_HOST = os.environ.get('RESTHEART_CLIENT_HOST')
RESTHEART_CLIENT_BASEURL = os.environ.get('RESTHEART_CLIENT_BASEURL')
RESTHEART_CLIENT_TOKEN = os.environ.get('RESTHEART_CLIENT_TOKEN')
RESTHEART_CLIENT_DS_DATABASE = os.environ.get('RESTHEART_CLIENT_DS_DATABASE')
RESTHEART_FILES_COLLECTION = os.environ.get('RESTHEART_FILES_COLLECTION')
